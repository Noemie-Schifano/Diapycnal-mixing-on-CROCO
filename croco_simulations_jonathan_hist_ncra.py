...
path_avg     = '/home/datawork-lops-megatl/RREXNUM/RREXNUM200_RSUP5_NOFILT_T/'
path_data     = '/home/datawork-lops-rrex/nschifan/RREXNUM200_RSUP5_NOFILT_T_copy/HIS/' 
path_data_grd = '/home/datawork-lops-rrex/nschifan/' 
...
class Croco(object): 
    ...
    def get_grid(self):
        ...
        nc1= Dataset(path_avg+'/HIS/'+self.name_exp+'_avg.00000.nc','r')
        self.Cs_r = nc1.Cs_r
        self.Cs_w = nc1.Cs_w
        self.hc   = nc1.hc
        nc1.close()  
    ...
    def get_outputs(self,*args,**kwargs): 
        ...
        print(self.name_exp)
        print(self.time)
        print(' ----'+ self.path_data+self.name_exp+'_his_00020-00058.nc' +' ----')
        print( ' --> temps:'+str(t))
        var_list = args[1]
        nvar = len(var_list) 
        self.var = {} 
        nc = Dataset(path_data+'rrexnum200_his_00020-00058.nc','r') 
    ...
    def get_diffusivity(self,*args,**kwargs):
        ...
        diff = np.asfortranarray(nc.variables[var_name][self.frame_index[t]].T)
        nc.close() 
